      ...
      <>
        {this.state.isVisible && (
          <View style={stylesModal}>
            <Text> Ваша рекомендуемая суточная норма калорий составляет: {this.props.dailyRate} </Text>
            ...
            {!this.props.isAuth && <TouchableOpacity onPress={()=>{this.props.JumpTo("Login")}}><Text>Go Reg</Text></TouchableOpacity>}
